...
# Always (re)apply the build settings — new_target does NOT set PRODUCT_NAME,
# which makes the product resolve to a bare ".appex" and archive fail with
# "Multiple commands produce .../.appex" (Codemagic build #245).
...
if created
  ...
  puts "#{WIDGET_NAME} target already present — settings refreshed"
end
