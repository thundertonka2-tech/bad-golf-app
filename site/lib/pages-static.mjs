...
const FAQ = [
  ...
  ['Does Bad Golf handle money?', 'No. Bad Golf never moves money. Games are scored in units, the app shows everyone\'s unit totals at the end of the round, and your group settles up however it already does.'],
  ['Which golf games can Bad Golf score?', 'More than 40, including Skins, Nassau, Wolf, Vegas, Banker, Stableford, Quota, Match play, Best ball, Scramble, Ryder Cup, Bingo Bango Bongo, Hammer and side games like greenies, sandies, snake and closest to the pin. Every game has a rules page under Games.'],
  ...
  ['Which courses does Bad Golf have?', 'Bad Golf has more than 11,000 courses across the United States with scorecards, tee ratings and slope, and GPS-mapped greens. If your course is missing you can add it inside the app in a couple of minutes.'],
  ['Can Bad Golf run my golf league?', 'Yes. Create a league season, invite players, and the app builds the schedule, matchups, flights, handicaps, standings and playoffs, week by week.'],
];
...
<section class="sec" id="features"><div class="wrap">
  <div class="sec-head"><div class="eyebrow">What it does</div><h2>Everything your Saturday group argues about, handled.</h2><p>Bad Golf was built for the guys and gals who play together every week and want the games, the handicaps and the bragging rights kept straight without a spreadsheet.</p></div>
  <div class="grid">
...
<section class="sec alt" id="games"><div class="wrap">
  <div class="sec-head"><div class="eyebrow">Games</div><h2>Every game your group already plays.</h2><p>Pick the games when you set up the round. Bad Golf tracks presses, carry-overs, multipliers and points hole by hole, then shows everyone's unit totals at the end.</p></div>
...
<section class="sec alt" id="courses"><div class="wrap">
  <div class="sec-head"><div class="eyebrow">Courses</div><h2>${courseCount.toLocaleString()} courses, scorecards included.</h2><p>Every course in Bad Golf comes with its scorecard, tee ratings and slope, and GPS-mapped greens. Look up your home course before you download.</p></div>
...
<section class="sec" id="download"><div class="wrap">
  <div class="dl">
    ...
    <div class="qr"><img src="/img/qr-get.svg" alt="QR code linking to the Bad Golf download page" width="170" height="170"><b>Scan to download</b><small>officialbadgolf.com/get</small></div>
  </div>
</div></section>
...
<section class="sec alt" id="faq"><div class="wrap">
  ...
  return page({
    headFirst: forwarder,
    path: '/', title: 'Bad Golf — Golf Scorecard, GPS & Side Games App for Your Group', h1: '',
...
export function features({ courseCount, gameCount }) {
  const rows = [
    ...
    ['🧾', 'Unit totals, not spreadsheets', 'At the end of the round the Board shows every game, every hole and a per-player unit total. Bad Golf does not move money; your group settles the way it always has.'],
  ...
  return page({ path: '/features/', title: 'Bad Golf Features — Live Scorecard, GPS, Handicaps, Leagues & Side Games', description: `Every feature in the free Bad Golf app: shared live scorecard, GPS rangefinder, ${gameCount}+ side games scored automatically, handicaps, leagues, tournaments, stats and badges.`, body, jsonld: [breadcrumbLd([{ name: 'Home', path: '/' }, { name: 'Features', path: '/features/' }])] });
}

export function download() {
  const body = `<section class="page wide"><div class="wrap">
  ${crumbs([{ name: 'Home', path: '/' }, { name: 'Download', path: '/download/' }])}
  <h1>Download Bad Golf</h1>
  ...
  <div class="qr-row">
    <div class="qr"><img src="/img/qr-get.svg" alt="QR code for the Bad Golf smart download link" width="170" height="170"><b>Any phone</b><small>officialbadgolf.com/get sends iPhones to the App Store and Androids to Google Play</small></div>
    <div class="qr"><img src="/img/qr-appstore.svg" alt="QR code for Bad Golf on the App Store" width="170" height="170"><b>App Store</b><small>iPhone, iPad and Apple Watch</small></div>
    <div class="qr"><img src="/img/qr-play.svg" alt="QR code for Bad Golf on Google Play" width="170" height="170"><b>Google Play</b><small>Android phones and tablets</small></div>
  </div>
  <div class="prose" style="margin-top:32px">
    ...
    <h2>Using Bad Golf in a browser</h2>
...
export const getRedirect = () => `<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Get Bad Golf</title><meta name="robots" content="noindex"><link rel="canonical" href="${SITE}/download/">
...
export function notFound() {
  ...
  return page({ path: '/404.html', title: 'Page not found — Bad Golf', description: 'That page is out of bounds.', body, noindex: true });
}
