...
const FAQ = [
  ...
  ['How does scoring the games work?', 'Every game is scored in units. Set the units when you create the round, play, and at the end the Unit Totals card shows where everyone finished. Bad Golf just keeps score.'],
...
export function features({ courseCount, gameCount }) {
  const rows = [
    ...
    ['🧾', 'Unit totals, not spreadsheets', 'At the end of the round the Board shows every game, every hole and a per-player unit total. Bad Golf just keeps score.'],
